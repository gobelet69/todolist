...
function renderNav(active, basePath = "") {
  return `<div style="display:flex;gap:10px">
    <a href="${basePath}/" class="nav-link ${active === "boards" ? "active" : ""}">\u{1F4CB} Boards</a>
...
// .wrangler/tmp/bundle-8owtTn/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-8owtTn/middleware-loader.entry.ts
